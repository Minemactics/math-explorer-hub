...
export const Route = createFileRoute("/resources")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Real operations, real numbers. Case studies, use cases, blogs and e-books focused on Visibility, Connectivity, Accuracy, Granularity, and Adoptability." },
...
const cases = [
  ...
  { n: 2, title: "Sizing the tipper fleet with bucket-level data", sector: "Iron ore", module: "Mineoptic Visual", pillar: "Visibility, Granularity",
    body: "The planning team had been sizing the tipper fleet per excavator using trip counts and average cycle time — numbers the team didn't fully trust. Mineoptic Visual started reporting bucket counts per truck, load time per bucket, and queue time at the excavator. Within a shift, the manager could see which excavators were starving their fleet and which had excess tippers. The fleet was rebalanced within a week." },
  { n: 3, title: "Fleet status visibility in a low-network pit", sector: "Limestone", module: "Mineoptic Plus", pillar: "Connectivity, Visibility",
    body: "A standard GPS tracker deployment had been live for two years but never used by the operations manager — the public GSM coverage dropped in the deepest bench, so the pit floor was effectively invisible, and stationary assets synced late. Mineoptic Plus was deployed on the mine's own connectivity fabric. The pit floor came online, time-sync across moving and stationary assets held up, and the manager began using the fleet-status view as the primary operational screen." },
  { n: 4, title: "One canvas for production, fuel, and fleet", sector: "Bauxite", module: "Mineoptic Canvas", pillar: "Visibility, Adoptability",
...
const blogs = [
  ...
  { t: "How many tippers per excavator? The question nobody could answer", d: "Sizing the tipper fleet per excavator has historically been a rule-of-thumb exercise because the data wasn't there. With bucket and queue data, the answer becomes calculable. We walk through the method." },
  ...
  { t: "Adoption is the hardest pillar", d: "Visibility, Connectivity, Granularity are all engineering problems. Adoptability is a design problem — and it's the one that decides whether the system gets used. Here's how we approach it." },
];

const ebooks = [
  { t: "The Four Pillars of Mining Intelligence", sub: "The flagship Minematics guide.", d: "A detailed walk-through of Visibility, Connectivity, Granularity, and Adoptability — why these four, how they interact, and how to score your current setup against each one. Includes a pillar-by-pillar assessment framework and representative operational metrics." },
  ...
  { t: "Choosing Between GPS, Mineoptic, and Enterprise FMS", d: "A candid buyer's guide for mines deciding how far up the stack to go. What each category is actually good at, where each one stops, and how to match the choice to the operation." },
  { t: "Data Sovereignty in Mining Operations", d: "Why production and commercial data should stay inside the mine's infrastructure, what 'data sovereignty by design' actually means, and how Mineoptic Canvas is architected to deliver it." },
];
    ...
    <>
      <section className="bg-hero-gradient text-primary-foreground">
        <div className="container-page py-20 md:py-28">
          ...
          <h1 className="mt-5 max-w-4xl text-4xl font-bold md:text-6xl">What we're seeing in the field.</h1>
          <p className="mt-6 max-w-3xl text-lg text-primary-foreground/85 md:text-xl">
            ...
            productivity: Visibility, Connectivity, Accuracy, Granularity, Adoptability.
          </p>
        </div>
      </section>
