...
const blogs = [
  ...
  { t: "Adoption is the hardest pillar", d: "Visibility, Connectivity, Granularity are all engineering problems. Adoptability is a design problem — and it is the one that decides whether the system gets used. Here is how we approach it." },
];
